  ...
  return (
    <div>
      <div>
        ...
        <div>
          {tickerInfo.results.branding &&
          tickerInfo.results.branding.logo_url ? (
            <img
          ...
          {tickerInfo.results.homepage_url ? (
            <a
              href={tickerInfo.results.homepage_url}
          ...
          <p className="text-size14">
            Description:{" "}
            {tickerInfo.results.description || "No information found"}
          </p>
          <p className="text-size14">
            Market cap:{" "}
            {tickerInfo.results.market_cap
              ? `${parseFloat(
                  tickerInfo.results.market_cap
                ).toLocaleString()} USD`
          ...
          <p className="text-size14">
            ...
            {tickerInfo.results.share_class_shares_outstanding
              ? parseFloat(
                  tickerInfo.results.share_class_shares_outstanding
                ).toLocaleString()
              : "No information found"}
